    ...
    for hand in file:
        if hand.strip() != "":
            ...
            match items:
                ...
                case ['D', 'X']: # Lizzard - Losse (rock)
                    myHand = 0 + 1
                case ['D', 'Y']: # Lizzard - draw (lizzar)
                   myHand = 3 + 4
                case ['D', 'Z']:  # Lizzard - win (rock)
                    myHand = 6 + 1 


                case ['C', 'X']: # Spock - Losse (rock)
                    myHand = 0 + 1
                case ['C', 'Y']: # Spock - draw (spock)
                   myHand = 3 + 5
                case ['C', 'Z']:  # Spock - win (paper)
                    myHand = 6 + 2 
